...
We use the short message service Twitter. The provider is Twitter International Company, One Cumberland Place, Fenian Street, Dublin 2, D02 AX07, Ireland. You can customize your Twitter privacy settings in your user account. Click on the following link and log in: [Personalization and data](https://twitter.com/personalization/)

Data transmission to the US is based on the Standard Contractual Clauses (SCC) of the European Commission. Details can be found here: [Twitter Controller-to-Controller (Outbound) Data Protection Addendum](https://gdpr.twitter.com/en/controller-to-controller-transfers.html)

For details, see the [Twitter Privacy Policy](https://twitter.com/en/privacy/)
